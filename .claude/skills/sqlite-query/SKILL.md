...
```
~/Library/Application\ Support/com.gumpw.handbox/handbox.db
```
...
```bash
sqlite3 ~/Library/Application\ Support/com.gumpw.handbox/handbox.db ".tables"
```

### Show table schema

```bash
sqlite3 ~/Library/Application\ Support/com.gumpw.handbox/handbox.db ".schema TABLE_NAME"
```

### Query data

```bash
sqlite3 ~/Library/Application\ Support/com.gumpw.handbox/handbox.db "SELECT * FROM table_name LIMIT 10"
```
...
```bash
sqlite3 -header -column ~/Library/Application\ Support/com.gumpw.handbox/handbox.db \
...
```bash
sqlite3 -json ~/Library/Application\ Support/com.gumpw.handbox/handbox.db \
