  ...
  <div class="relative {autoWidth ? 'inline-flex' : 'w-full'}">
    <select
      ...
      class="appearance-none {autoWidth
        ...
        : size === 'sm'
          ? 'pr-2'
          : 'pr-3'} rounded-md bg-base-200 text-base-content hover:bg-base-300 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer transition-colors"
    >
      {#if placeholder}
