<script lang="ts">
  ...
  $: {
    const activeClasses = isActive
      ...
      : "";
    finalButtonClass = [defaultButtonClass, activeClasses, buttonClass]
      .filter(Boolean)
      .join(" ");
    finalIconClass = [defaultIconClass, iconClass].filter(Boolean).join(" ");
  }
...
<button class={finalButtonClass} on:click={onClick}>
