...
export const settingsEn: Record<keyof typeof settingsZh, string> = {
  ...
  "settings.about.promptInterval": "Reminder frequency",
  "settings.about.promptIntervalDesc":
    "Shortest gap between two update dialogs opened automatically",
  "settings.about.promptInterval.launch": "Every launch",
  "settings.about.promptInterval.hourly": "Hourly",
  "settings.about.promptInterval.daily": "Daily",
  "settings.about.promptInterval.weekly": "Weekly",
  "settings.about.promptInterval.never": "Never",
